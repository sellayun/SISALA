...
<html>
    <head>
        <title>Arusku - Reset Password</title>
        <meta charset="utf-8">
            ...
            <div class="uk-card uk-card-default margin-kiri-kanan" style="border-radius: 10px;">
                <div class="uk-grid-collapse uk-child-width-1-1@s uk-child-width-1-1@s" uk-grid>
                    <div class="padding-kiri-kanan">
                        <h3 class="uk-text-center"><b>Reset Password</b></h3>
                        ...
                        <p class="uk-text-center" style="margin-top: 0;">Atau belum punya akun? <a href="register">Register disini</a></p>
                            ...
                            @endif
                        <form action="/resetpassword/aksi" method="POST">
                            {{ csrf_field() }}
                            <fieldset class="uk-fieldset">
                                ...
                                <div class="uk-margin">
                                    <button class="uk-button uk-button-primary" style="width: 100%; border-radius: 5px; text-transform: none;">Reset Password</button>
                                </div>
                            </fieldset>
                        </form>
                    </div>
