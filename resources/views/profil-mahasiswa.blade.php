  ...
  <div class="col-lg-12 mb-12">
    ...
    <div class="card shadow mb-4" style="border-radius: 15px;">
      ...
      <div class="card-body" style="padding: 120px 300px;">
                  ...
                  <br>
                  <form action="/profil/mahasiswa" id="form" method="POST" enctype="multipart/form-data">
                    {{ csrf_field() }}
                      <input type="text" name="nama" value="{{$nama}}" hidden="">
                      <input type="email" name="email" value="{{$email}}" hidden="">
                      <input type="text" name="nim" value="{{$nim}}" hidden="">
                      <input type="number" name="phone" value="{{$phone}}" hidden="">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="nama" class="form-control" id="exampleInputPassword1" aria-describedby="emailHelp" placeholder="Masukkan Nama Lengkap" value="{{$nama}}" required>
                  </div>
                  <div class="form-group">
                    <lable>Email</lable>
                    <input type="email" name="email" class="form-control" id="exampleInputPassword2" aria-describedby="emailHelp" placeholder="Masukkan Email" value="{{$email}}" readonly>
                  </div>
                  <div class="form-group">
                    <lable>NIM</lable>
                    <input type="text" name="nim" class="form-control" id="exampleInputPassword3" aria-describedby="emailHelp" placeholder="Masukkan NIM" value="{{$nim}}" required>
                  </div>
                  <div class="form-group">
                    <lable>Phone</lable>
                    <input type="number" name="phone" class="form-control" id="exampleInputPassword4" aria-describedby="emailHelp" placeholder="Masukkan Phone" value="{{$phone}}" required>
                  </div>
        ...
        <form action="/profil/mahasiswa" method="POST" enctype="multipart/form-data">
                  {{ csrf_field() }}
